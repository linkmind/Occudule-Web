    ...
    >
      ...
      <div className="relative mx-auto max-w-content px-gutter py-section md:py-24">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-relaxed text-primary/75 md:text-xl">
          Occudule uses AI to triage school threads, summarize long chains, and draft replies in
          your voice—cutting email time without dropping the ball on what matters for your family.
        </p>
